            ...
            <div class="row">
                ...
                <div class="col-8">
                    <ul class="topbar-menu">
                        <li class="navlink"><a href="#">Career</a></li>
                        <li class="navlink"><a href="#">Sustainability</a></li>
                        <li class="navlink"><a href="#">Investors</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="about.php"><span class="rolling-text">Barani Group</span></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="product.php" role="button"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><span class="rolling-text">Capabilities</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><span class="rolling-text">Sustainability
                            </span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><span class="rolling-text">Contact Us
                            </span></a>
                    </li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="sub-menu2">
                                                <ul>
                                                    <li>
                                                        <a href="#" class="sub-link">Services v1</a>
                                                    </li>
                                                    <li>

    ...
    <div class="row g-3" id="contentTypeSelector">
        ...
        <div class="col-md-4">
            <label class="type-card" data-type="pdf">
                ...
                <div class="card h-100 border-2 {{ old('type', $blog->type ?? '') == 'pdf' ? 'border-primary' : '' }}">
        ...
        <div class="col-md-4">
            <label class="type-card" data-type="video">
                ...
                <div class="card h-100 border-2 {{ old('type', $blog->type ?? '') == 'video' ? 'border-primary' : '' }}">
                    <div class="card-body text-center py-4">
        ...
        <div class="col-md-4">
            <label class="type-card" data-type="gallery">
                ...
                <div class="card h-100 border-2 {{ old('type', $blog->type ?? '') == 'gallery' ? 'border-primary' : '' }}">
                    <div class="card-body text-center py-4">

...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="section-header mt-4">
            ...
            <h2 class="mb-0 text-uppercase">What We Offer</h2>
        </div>
            ...
            <div class="col-md-12">
                <div class="page-box animate-fade-in">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="mb-0"><i class="bi bi-collection-fill me-2"></i> List</h5>
                    ...
                    <div id="videoContent" style="display: none;" class="animate-fade-in">
                        <div class="form-section mt-3 mb-4">
                            <h5 class="mb-3"><i class="bi bi-plus-circle me-2"></i>Add New Offer</h5>
                            <form action="{{ route('organization.store') }}" method="POST" enctype="multipart/form-data" id="addFacilityForm">
                                @csrf
                                <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="Latestvidesoass" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                @foreach($OrganizationDetatil as $key => $video)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{ $video->title }}</td>
                                    ...
                                    <td>
                                        <div class="action-btns">
                                            <button type="button" class="smart-btn smart-btn-primary edit-btn-detail"
                                                data-id="{{ $video->id }}"
                                                data-title="{{ $video->title }}"
                                               
                                                data-description="{{ $video->description }}"
                                                data-action="{{ route('organization.detail.update', $video->id) }}"
                                                data-bs-toggle="modal" data-bs-target="#editModalDetailpageeee">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </button>
                                            
                                          <button type="button" class="smart-btn smart-btn-danger" onclick="confirmDelete({{ $video->id }})">
...
<!-- Edit Facility Modal -->
<div class="modal fade" id="editModalDetailpageeee" tabindex="-1" aria-labelledby="editVideoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editVideoModalLabel"><i class="bi bi-pencil-square me-2"></i>Edit</h5>
            ...
            <div class="modal-body">
                <form id="editFormDetailsPAge" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="editTitle" class="form-label fw-medium">Title<span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="bi bi-type"></i></span>
                                <input class="form-control" type="text" id="editTitle" name="title" placeholder="Enter Title" required />
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bi bi-justify"></i></span>
                                <textarea class="form-control" id="editDescription" name="description" placeholder="Description" style="height: 120px;" required></textarea>
                            </div>
                        </div>
...
<!-- Delete Forms (Hidden) -->
@foreach($OrganizationDetatil as $video)
<form id="delete-form-{{ $video->id }}" action="{{ route('organization.detail.delete', $video->id) }}" method="POST" style="display: none;">
    @csrf 
    @method('DELETE')
</form>
@endforeach
...
<script>
    ...
    function toggleContent() {
        ...
        if (content.style.display === "none" || content.style.display === "") {
            ...
            button.innerHTML = '<i class="bi bi-plus-circle"></i> New Organization';
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        editButtons.forEach((button) => {
            button.addEventListener("click", function() {
                ...
                const image2 = this.getAttribute("data-image");
                const description = this.getAttribute("data-description");
                const actionUrl = this.getAttribute("data-action");

                document.getElementById("editFormDetailsPAge").setAttribute("action", actionUrl);

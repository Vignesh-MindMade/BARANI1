    ...
    <div class="page-wrapper">
                        ...
                        <div class="col-md-6">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-md-end mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">HomePage / Organization</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-box">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    @foreach ($Organizations as $key => $video)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="action-btns">
                                                    <button type="button"
                                                        ...
                                                        data-action="{{ route('organization.update', $video->id) }}"
                    ...
                    <button class="btn btn-primary"> <a href="{{ route('organization.detail') }}" class="text-white"><i class="bi bi-plus-circle"></i> Add Organization Details</a></button>
                </div>
            </div>
        </div>

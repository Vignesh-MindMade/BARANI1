    ...
    <div class="page-wrapper">
                        ...
                        <div class="col-md-6">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-md-end mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">HomePage / FAQ Contents</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-box">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    @foreach ($FAQTitles as $key => $video)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="action-btns">
                                                    <button type="button"
                                                        ...
                                                        data-action="{{ route('faqtitle.update', $video->id) }}"
                    ...
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModalDetailpageeee">
                        <i class="bi bi-plus-circle me-1"></i> <a href="{{ route('faq.index') }}" class="text-white">Add New FAQ Details</a>
                    </button>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-field">
                                <div class="form-field-title">
                                    <i class="bi bi-type"></i> <Title></Title> <span class="required-asterisk">*</span>
                                </div>
    ...
    <script>
     ...
     editButtons.forEach((button) => {
          button.addEventListener("click", function() {
               ...
               document.getElementById("editTitle").value = title; // Fixed from editname to editTitle

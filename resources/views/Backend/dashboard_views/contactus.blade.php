    ...
    <div class="page-content">
        ...
        <div class="stats-header">
            <div class="stats-item">
                <span class="stats-number">{{ $ContactForms->count() }}</span>
                <span class="stats-label">Total Submissions</span>
            </div>
            <div class="stats-item">
                <span class="stats-number">{{ $ContactForms->where('created_at', '>=', now()->subDays(7))->count() }}</span>
                <span class="stats-label">This Week</span>
            </div>
            <div class="stats-item">
                <span class="stats-number">{{ $ContactForms->where('created_at', '>=', now()->subDays(30))->count() }}</span>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="contactTable" class="table mb-0">
                        <thead>
                            <tr>
                                <th><i class="fas fa-hashtag icon-sm"></i> #</th>
                                <th><i class="fas fa-user icon-sm"></i> Name</th>
                                <th><i class="fas fa-envelope icon-sm"></i> Email</th>
                                <th><i class="fas fa-tag icon-sm"></i> Subject</th>
                                <th><i class="fas fa-comment-dots icon-sm"></i> Message</th>
                        ...
                        <tbody>
                            @foreach($ContactForms as $index => $contact)
                                <tr>
                                    ...
                                    <td class="contact-message" title="{{ $contact->message }}">
                                        {{ Str::limit($contact->message, 800) }}
                                    </td>
...
$(document).ready(function () {
    $('#contactTable').DataTable({
        ...
        "language": {
            ...
            "emptyTable": "<div class='text-center py-5'><i class='fas fa-inbox fa-4x text-muted mb-3'></i><p class='h5 text-muted'>No submissions yet</p><p class='text-muted'>Contact submissions will appear here.</p></div>"
        },
...
function refreshTable() {
    Swal.fire({
        title: 'Refreshing...',
        text: 'Updating contact submissions',
        icon: 'info',

...
@section('wrapper')
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="row align-items-center mb-4">
                    <div class="col-md-6">
                        <div class="section-header">
                            ...
                            <h2 class="mb-0 text-uppercase">SUPPLIER SPACE</h2>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-md-end mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">SUPPLIER SPACE</li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="page-box animate-fade-in">
                <div class="section-header">
                    ...
                    <h4 class="mb-0 text-uppercase">SUPPLIER SPACE Management</h4>
                </div>

                @foreach ($heading as $head)
                    <form method="POST" action="{{ route('supplier_space.update', $head->id) }}"
                        enctype="multipart/form-data" class="needs-validation mb-5 p-4 border rounded shadow-sm bg-light"
                        novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="3">{{ $head->description }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @if ($head->image)
                                <img src="{{ asset('images/' . $head->image) }}" width="120"
                                    class="mt-2 rounded shadow-sm">
                            @endif
                        </div>
                        ...
                        <!-- Mission Description -->
                        <div class="mb-3">
                            <label class="form-label fw-medium" for="hydraulic_press_manufacturing">Hydraulic Press
                                Manufacturing Count</label>
                            <input type="text" class="form-control" id="hydraulic_press_manufacturing"
                                name="hydraulic_press_manufacturing" value="{{ $head->hydraulic_press_manufacturing }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-medium" for="custom_automation_solutions">Custom Automation
                                Solutions Count</label>
                            <input type="text" class="form-control" id="custom_automation_solutions"
                                name="custom_automation_solutions" value="{{ $head->custom_automation_solutions }}">
                        </div>
                ...
                <button><a href="{{ route('Homepagetestimonial.index') }}" class="btn btn-primary">Testimonial</a></button>
                <!-- Our Facilities Section -->
               <div class="section-header mt-4">
                    <i class="bi bi-building-fill-gear"></i>
                    <h2 class="mb-0 text-uppercase">Our FAQ List</h2>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="page-box animate-fade-in">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="mb-0"><i class="bi bi-collection-fill me-2"></i> FAQ</h5>
                            ...
                            <div id="videoContent" style="display: none;" class="animate-fade-in">
                                <div class="form-section mt-3 mb-4">
                                    <h5 class="mb-3"><i class="bi bi-plus-circle me-2"></i>Add New FAQ</h5>
                                    <form action="{{ route('faqnew.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="question"
                                                        name="question" placeholder="Enter Year" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" id="answer" name="answer" placeholder="Description" style="height: 120px;"
                                                        required></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="number" id="order_id"
                                ...
                                <table id="Latestvidesoass" class="table table-bordered table-hover table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><i class="bi bi-type me-1"></i>Question</th>
                                    ...
                                    <tbody>
                                        @foreach ($faq as $key => $video)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>
                                                    <strong>{{ $video->question }}</strong>
                                                    <div class="text-muted small mt-1">Order:
                                                        #{{ $video->order_id ?? 'N/A' }}</div>
                                                </td>
                                                <td>
                                                    <div class="action-btns">
                                                        <button type="button"
                                                            ...
                                                            data-id="{{ $video->id }}"
                                                            data-question="{{ $video->question }}"
                                                            data-order_id="{{ $video->order_id }}"
                                                            data-answer="{{ $video->answer }}"
                                                            data-action="{{ route('faqnew.update', $video->id) }}"
       ...
       <div class="modal fade" id="editModalDetailpageeee" tabindex="-1" aria-labelledby="editVideoModalLabel"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editFormDetailsPAge" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="editQuestion" class="form-label fw-medium">Year<span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bi bi-type"></i></span>
                                        <input class="form-control" type="text" id="editQuestion" name="question"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="number" id="editSortId" name="order_id"
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="editAnswer" class="form-label fw-medium">Answer<span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bi bi-type"></i></span>
                                        <input class="form-control" type="text" id="editAnswer" name="answer"
        ...
        @foreach ($faq as $video)
            <form id="delete-form-{{ $video->id }}" action="{{ route('faqnew.delete', $video->id) }}"
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                editButtons.forEach((button) => {
                    button.addEventListener("click", function() {
                        ...
                        const order_id = this.getAttribute("data-order_id");
                        ...
                        document.getElementById("editSortId").value = order_id;

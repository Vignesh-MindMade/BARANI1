...
<div id="smooth-wrapper">
        <div id="smooth-content">
            <main class="main-bg ">
                <section class="page-header-cerv bg-img section-padding" data-background="{{ asset('assets/frontend/images/banner/banner.webp') }}" data-overlay-dark="4">
                        ...
                        <div class="row rest form-img-box">
                            ...
                            <div class="item mb-20">
                                <div class="content main-bg p-20">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <h4 class="mb-10"><a href="#0">{{ $carrer->job_title }}</a></h4>
                                        </div>
                                    </div>
                        ...
                        <div class="row rest justify-content-center form-img-box">
                            ...
                            <div class="col-lg-7 col-12 rest">
                                <div class="form-box">
                                    ...
                                    <form id="supplier-form" method="post" action="{{ route('career.apply') }}" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <select name="unit" class="form-control" required>
                                        ...
                                        <option value="Unit2">Pressed Components and Sub-Assembly</option>
                                        ...
                                        <div class="form-check mb-4">
                                            ...
                                            <label class="form-check-label" for="agreement">
                                                ...
                                                Barani Hydraulics’ <a href="#">recruitment terms and privacy policy</a>.
                                            </label>
                                        </div>

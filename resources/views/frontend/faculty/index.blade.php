...
<body>
    ...
    <section>
        <div class="faculty-content">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2> The Right Faculty </h2>
                        <div class="heading-bottom-line"></div>
                    </div>
                    <div class="col-md-6">
                        <p>
                            At Chinmaya, we take our teaching seriously and believe that the most important aspect of a
                            school is the quality of their faculty.
                            We have seen over the past 94 years that when a child is comfortable and having fun while
                            learning, the child is able to grasp the subject
                            much more efficiently. We make sure it is the right person for the right job at all times.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section>
        <div class="faculty">
            <div class="container">
                <div class="row">
                    @foreach ($Infrastructurefronts as $item)
                        <div class="col-md-3">
                            <ul class="faculty-details">
                                <li class="title">{{ $item->title }}</li>
                                @foreach ($InfrastructureDetatils->where('Infrastructure_id', $item->id) as $detail)
                                    <li>{{ $detail->infrastructure_title }}</li>
                                @endforeach
                            </ul>
                        </div>
                        <br>

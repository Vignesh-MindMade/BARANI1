...
#modalProductImages img:hover {
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-area-inner">
                        <span class="water-text">General</span>
                        <h1 class="title">
                            General
                        </h1>
                        <div class="nav-area-navigation">
                            <a href="#">home</a>
                            <a class="current" href="#">General</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="section-gap1 dark-bg">
        <div class="container mt-10">
            @foreach ($ProductOEMS as $Textile)
                <div class="rts-title-between-area-four mt-2 mb-2">
                    <h6>{{ $Textile->catagory_name }}</h6>
                </div>
                <div class="row">
                    @foreach ($OEMS->where('product_oem_id', $Textile->id) as $text)
        ...
        document.querySelectorAll('.view-details-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                if (images.length) {
                    ...
                    // Fallback to thumbnail if no additional images
                    let imgElem = document.createElement('img');
                ...
                if (points.length) {
                    ...
                    // Show default message if no points
                    let li = document.createElement('li');

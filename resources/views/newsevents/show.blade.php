...
@section("wrapper")
<h1>image</h1>
<h1><img src="{{ asset('images/' . $event->image1) }}" alt="{{ $event->name }}" style="max-width: 100px;"></h1>
<h1><img src="{{ asset('images/' . $event->image2) }}" alt="{{ $event->name }}" style="max-width: 100px;"></h1>
<h1><img src="{{ asset('images/' . $event->image3) }}" alt="{{ $event->name }}" style="max-width: 100px;"></h1>
<h1><img src="{{ asset('images/' . $event->image4) }}" alt="{{ $event->name }}" style="max-width: 100px;"></h1>
<h1><img src="{{ asset('images/' . $event->image5) }}" alt="{{ $event->name }}" style="max-width: 100px;"></h1>
<h1><img src="{{ asset('images/' . $event->image6) }}" alt="{{ $event->name }}" style="max-width: 100px;"></h1>
<h1><img src="{{ asset('images/' . $event->image7) }}" alt="{{ $event->name }}" style="max-width: 100px;"></h1>
<h1><img src="{{ asset('images/' . $event->image8) }}" alt="{{ $event->name }}" style="max-width: 100px;"></h1>
@endsection

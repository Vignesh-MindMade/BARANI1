...
<footer class="footer-section  footer-container section-padding pb-60 text-white ">
        ...
        <div class="row">
            <div
                ...
                <div class="footer-logo mb-3 icon-img-100">
                    <img src="<?php echo e(asset('assets/frontend/imgs/logo-light.png')); ?>" alt="footer-logo" />
                </div>
                <?php $__currentLoopData = $footertexts->sortBy('sort_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footertext): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                <p class="footer-para">
                  <?php echo e($footertext->text); ?>
   ...
   <!--Social Links-->
    ...
    <?php $__currentLoopData = $socials->sortBy('sort_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <ul class="d-flex list-unstyled gap-2 mb-0">

            <?php if(!empty($social->facebook) && $social->facebook !== '#'): ?>
                <li>
                    <a href="<?php echo e($social->facebook); ?>" target="_blank" class="text-white fs-5">
            ...
            <?php if(!empty($social->instagram) && $social->instagram !== '#'): ?>
                <li>
                    <a href="<?php echo e($social->instagram); ?>" target="_blank" class="text-white fs-5">
            ...
            <?php if(!empty($social->twitter) && $social->twitter !== '#'): ?>
                <li>
                    <a href="<?php echo e($social->twitter); ?>" target="_blank" class="text-white fs-5">
            ...
            <?php if(!empty($social->linkedin) && $social->linkedin !== '#'): ?>
                <li>
                    <a href="<?php echo e($social->linkedin); ?>" target="_blank" class="text-white fs-5">
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div
                ...
                <h6 class="mb-2">Quick Access</h6>
                 <?php $__currentLoopData = $QuickAccess->sortBy('sort_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $QuickAcces): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <ul class="navbar-nav footer-navbar ">
                    <li class="nav-item "><a class="nav-link" target="_blank" href="<?php echo e($QuickAcces->link); ?>"><?php echo e($QuickAcces->pagename); ?></a></li>
                </ul>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div
                ...
                <?php $__currentLoopData = $contacts->sortBy('sort_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <p class="address">
                ...
                <p><a href="#" class="nav-link">
                        <?php echo e($contact->contact_no_1); ?><br />
                       <?php echo e($contact->contact_no_2); ?>

                    </a></p>
                <p><a href="#" class="nav-link"> <?php echo e($contact->mail); ?></a></p>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<form id="brochureForm" method="POST" action="<?php echo e(route('brochure.lead.store')); ?>">
<?php echo csrf_field(); ?>

<!-- Hidden field to pass brochure filename - only pass if exists -->
<?php if(!empty($page->brochure)): ?>
<input type="hidden" name="brochure_file" value="<?php echo e($page->brochure); ?>" autocomplete="off">
<?php endif; ?>
...
<script src="<?php echo e(asset('assets/frontend/js/jquery-migrate-3.4.0.min.js')); ?>"></script>
<!-- plugins -->
...
<script src="<?php echo e(asset('assets/frontend/js/ScrollSmoother.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/js/ScrollTrigger.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/js/smoother-script.js')); ?>"></script>
<!-- custom scripts -->
...
<?php /**PATH D:\herd\barani_live\resources\views/layouts_front/footer.blade.php ENDPATH**/ ?>
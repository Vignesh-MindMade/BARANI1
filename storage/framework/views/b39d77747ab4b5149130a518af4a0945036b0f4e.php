    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-box animate-fade-in">
                ...
                <div class="section-header">
                    <i class="bi bi-bookmark-star-fill fs-4"></i>
                    <h4 class="mb-0 text-uppercase"><a href="<?php echo e(route('productarchives.index')); ?>" class="btn btn-primary">Product Archive</a></h4>
                </div>
               </div> 
               ...
               <div class = "col-md-6"> 
                <div class="section-header">
                    <i class="bi bi-bookmark-star-fill fs-4"></i>
                    <h4 class="mb-0 text-uppercase"><a href="<?php echo e(route('viewindex.index')); ?>" class="btn btn-primary">Product Page</a></h4>
                </div>
               </div>
                        ...
                        <div class="page-box animate-fade-in">
                            ...
                            <div id="videoContent" style="display: none;" class="animate-fade-in">
                                <div class="form-section mt-3 mb-4">
                                    ...
                                    <form action="<?php echo e(route('product_catagory.store')); ?>" method="POST"
                          ...
                          <div class="table-responsive">
                                <table id="Latestvidesoass" class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $catagorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($key + 1); ?></td>
                                                <td>
                                                    <strong><?php echo e($video->catagory); ?></strong>
                                                ...
                                                <td>
                                                    <div class="action-btns">
                                                        <button type="button"
                                                            ...
                                                            data-catagory="<?php echo e($video->catagory); ?>"
                                                            data-order_id="<?php echo e($video->sort_id); ?>"
                                                            data-action="<?php echo e(route('product_catagory.update', $video->id)); ?>"
       ...
       <div class="modal fade" id="editModalDetailpageeee" tabindex="-1" aria-labelledby="editVideoModalLabel"
        ...
        <?php $__currentLoopData = $catagorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <form id="delete-form-<?php echo e($video->id); ?>" action="<?php echo e(route('product_catagory.delete', $video->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\herd\barani_live\resources\views/Backend/Product/index.blade.php ENDPATH**/ ?>
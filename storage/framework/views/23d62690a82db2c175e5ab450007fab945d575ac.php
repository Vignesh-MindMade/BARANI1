...
<style>
    ...
    .page-banner {
        background: url('<?php echo e($blog->banner_image_url ?? asset('images/default-banner.jpg')); ?>') no-repeat center center;
...
<div class="page-wrapper">
    <div class="page-box page-content">
        <div class="banner-manager-container py-4 px-4">
            ...
            <?php if($blog->banner_image || $blog->banner_title): ?>
                <div class="page-banner" style="background-image: url('<?php echo e($blog->banner_image_url); ?>');">
                    <h1><?php echo e($blog->banner_title ?: 'Blog Posts'); ?></h1>
                </div>
            <?php endif; ?>

            
            <div class="section-header">
                <h2><?php echo e($blog->section1_title ?: 'Our Blog Feed'); ?></h2>
                <?php if($blog->section1_subtitle): ?><p class="text-muted mb-0"><?php echo e($blog->section1_subtitle); ?></p><?php endif; ?>
                <?php if($blog->section1_description): ?><div class="mt-2 text-muted"><?php echo Str::markdown($blog->section1_description); ?></div><?php endif; ?>
            </div>
            ...
            <div class="form-section">
                <div class="form-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('blogs-admin.create')); ?>" class="btn psg-p-btn">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo e($blog->banner_image_url); ?>" alt="<?php echo e($blog->banner_title ?: $blog->title); ?>" class="thumb-img">
                                    </td>
                                    <td>
                                        <strong style="color: #1a3a5c; font-size: 14px;"><?php echo e(Str::limit($blog->title, 45)); ?></strong>
                                        <div class="text-muted" style="font-size: 12px; margin-top: 2px;"><?php echo e(Str::limit($blog->description, 70)); ?></div>
                                    </td>
                                    <td>
                                        <span class="type-badge-custom" style="background: <?php echo e($blog->type_badge_color); ?>;">
                                            <?php if($blog->type === 'pdf'): ?>
                                                <i class="fas fa-file-pdf"></i>
                                            <?php elseif($blog->type === 'video'): ?>
                                                <i class="fas fa-video"></i>
                                            <?php elseif($blog->type === 'image'): ?>
                                    ...
                                    <td><?php echo e($blog->sort_order); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('blogs-admin.edit', $blog)); ?>" class="action-btn btn-edit" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?php echo e(route('blogs.show', $blog)); ?>" target="_blank" class="action-btn btn-view" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <button type="button" class="action-btn btn-delete" title="Delete" onclick="confirmDelete(<?php echo e($blog->id); ?>)">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="8" class="text-center py-5 text-muted">
                                        ...
                                        No blogs found. <a href="<?php echo e(route('blogs-admin.create')); ?>">Create one</a>.
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
...
<?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <form id="delete-form-<?php echo e($blog->id); ?>" action="<?php echo e(route('blogs-admin.destroy', $blog)); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\herd\barani_live\resources\views/Backend/blogs/index.blade.php ENDPATH**/ ?>
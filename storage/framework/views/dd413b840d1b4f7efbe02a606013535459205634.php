...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?php echo e(asset('assets/frontend/imgs/favicon.png')); ?>" type="image/x-icon">
    ...
    <!-- Fonts / Icons / CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/satoshi.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/plugins.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/timeline.css')); ?>">
...
<body class="max">
    ...
    <?php echo $__env->make('layouts_front.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <div  id="smooth-wrapper" class="max-width-2000">
        <div id="smooth-content">
            <main class="main-bg o-hidden">

                <?php echo $__env->yieldContent('contentFront'); ?>

            </main>

            <?php echo $__env->make('layouts_front.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
...
<?php /**PATH D:\herd\barani_live\resources\views/layouts_front/app.blade.php ENDPATH**/ ?>
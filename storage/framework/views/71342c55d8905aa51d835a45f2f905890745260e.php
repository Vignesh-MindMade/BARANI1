...
.search-form.active .close-search {
   ...
   <div class="progress-wrap cursor-pointer">
        ...
        <div class="loader-wrap-heading">
            <div class="load-text">
                <a class="logo icon-img-200" href="index.php">
                    <img src="<?php echo e(asset('assets/frontend/imgs/logo-light.png')); ?>" alt="logo">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8 d-none d-lg-block">
                    <ul class="topbar-menu">
                        <!--<li class="navlink"><a href="<?php echo e(route('download_page.index')); ?>">Downloads Page</a></li>-->
                        <li class="navlink"><a href="<?php echo e(route('carrers.index')); ?>">Careers</a></li>
                        <li class="navlink"><a href="<?php echo e(route('supplier.index')); ?>">Supplier</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <nav class="navbar navbar-expand-lg  change blur">
        <div class="container">
            <a class="logo icon-img-100" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('assets/frontend/imgs/logo-light.png')); ?>" alt="logo">
            </a>
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link " href="<?php echo e(url('/')); ?>" role="button" aria-haspopup="true"
                     ...
                     <li class="nav-item dropdown">
                       ...
                       <div class="dropdown-menu flex-column">
                           <a class="dropdown-item" href="<?php echo e(route('aboutus.index')); ?>">About Us</a>
                           <?php $__currentLoopData = $BaraniSubmenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <?php $firstPage = $submenu->pages->first(); ?>
                               <?php if($firstPage && ($firstPage->template ?? '') === 'template2'): ?>
                                   <a class="dropdown-item"
                                       href="<?php echo e(route('frontend.groupsubmenu.page.view', $firstPage->id)); ?>">
                                       <?php echo e($submenu->submenu_name); ?>

                                   </a>
                               <?php else: ?>
                                   <a class="dropdown-item"
                                       href="<?php echo e(route('frontend.groupsubmenu.view', $submenu->id)); ?>">
                                       <?php echo e($submenu->submenu_name); ?>
                           ...
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <a class="dropdown-item" href="<?php echo e(url('/jsr')); ?>"><?php echo e($JSRMenu->menu_name ?? 'Jaishriram Engineering College'); ?></a>
                       </div>
                   </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu flex-column">
                            ...
                            <?php $__currentLoopData = $ProductCatagorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="dropdown-item">
                                    <a
                                        href="<?php echo e($category->slug ? route('archive.page', $category->slug) : 'javascript:void(0)'); ?>">
                                        <?php echo e($category->catagory); ?>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu flex-column"  aria-labelledby="capabilitiesDropdown">
        <?php $__currentLoopData = $CapabilitiesSubmenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $firstPage = $submenu->pages->first(); ?>

            <?php if($firstPage): ?>
                <li>
                    <a class="dropdown-item"
                       href="<?php echo e(route('capabilities.page', $firstPage->slug)); ?>">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link"href="<?php echo e(route('sustainability.index')); ?>"><span class="rolling-text">Sustainability
                            </span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('contactus.index')); ?>"><span class="rolling-text">Contact Us
                            </span></a>
                    </li>
                    ...
                    <div class="col-lg-7">
                        <div class="menu-links">
                            <ul class="main-menu rest">
                                <li>
                                    <div class="o-hidden">
                                        <a href="<?php echo e(url('/')); ?>" class="link"><span class="fill-text" data-text="Home">Home</span></a>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="sub-menu">
                                        <ul>
                                            <li>
                                                <a href="<?php echo e(route('aboutus.index')); ?>" class="sub-link">About Us</a>
                                            </li>
                                <li>
                                              <?php $__currentLoopData = $BaraniSubmenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <?php $firstPage = $submenu->pages->first(); ?>
                           ...
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li>
                                                <a href="<?php echo e(url('/jsr')); ?>" class="sub-link"><?php echo e($JSRMenu->menu_name ?? 'Jaishriram Engineering College'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="sub-menu no-bord">
                                        <ul>
                                            ...
                                            <span data-text="<?php echo e($category->catagory); ?>"><a href="<?php echo e($category->slug ? route('archive.page', $category->slug) : 'javascript:void(0)'); ?>" class="link blink"><?php echo e($category->catagory); ?></a></span>
                                                ...
                                                <div class="sub-menu2">
                                                    <ul>
                                                        <?php $__empty_1 = true; $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <li>
                                                            <a href="<?php echo e(route('product.detail', $product->slug)); ?>" class="sub-link">
                                                                <?php echo e($product->product_title); ?>
...
<li>
    ...
    <div class="sub-menu">
        <ul>
            <?php $__empty_1 = true; $__currentLoopData = $CapabilitiesSubmenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
            ...
            <?php endif; ?>
                                ...
                                <li>
                                    <div class="o-hidden">
                                        <a href="<?php echo e(route('sustainability.index')); ?>" class="link">
                                ...
                                <li>
                                    <div class="o-hidden">
                                        <a href="<?php echo e(route('contactus.index')); ?>" class="link">
                                ...
                                <!--<li>-->
                                <!--    <div class="o-hidden">-->
                                <!--        <a href="<?php echo e(route('download_page.index')); ?>" class="link">-->
                                ...
                                <li>
                                    <div class="o-hidden">
                                        <a href="<?php echo e(route('carrers.index')); ?>" class="link">
                                ...
                                <li>
                                    <div class="o-hidden">
                                        <a href="<?php echo e(route('supplier.index')); ?>" class="link">
...
document.getElementById('searchInput').addEventListener('keyup', function () {
    ...
    fetch(`<?php echo e(route('product.suggestions')); ?>?query=` + query)
...
<?php /**PATH D:\herd\barani_live\resources\views/layouts_front/header.blade.php ENDPATH**/ ?>
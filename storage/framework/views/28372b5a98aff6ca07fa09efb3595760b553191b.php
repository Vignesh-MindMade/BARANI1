        ...
        <div class="page-content">
            <div class="container">
                        ...
                        <div class="page-box">
                            <div class="table-responsive">
                                <table id="example" class="table table-bordered" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $topbars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $topbar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="text-center">
                                                    <span class="serial-number"><?php echo e($key + 1); ?></span>
                                                </td>
                                                <td>
                                                    <div class="page-name">
                                                        ...
                                                        <span><?php echo e($topbar->title); ?></span>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <?php echo e($topbar->sort_id ?? '--'); ?>

                                                </td>
                                                <td class="text-center">
                                                    <button type="button" class="view-btn edit-btn"
                                                        data-bs-toggle="modal" data-bs-target="#editModal"
                                                        data-id="<?php echo e($topbar->id); ?>" data-title="<?php echo e($topbar->title); ?>"
                                                        data-description="<?php echo e($topbar->description); ?>"
                                                        data-catagory="<?php echo e($topbar->catagory); ?>"
                                                        data-updated_on="<?php echo e($topbar->updated_on); ?>"
                                                        data-pdf="<?php echo e($topbar->pdf); ?>"
                                                        data-sort-id="<?php echo e($topbar->sort_id); ?>"
                                                        data-action="<?php echo e(route('topbar.update', ['id' => $topbar->id])); ?>">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </button>
                                                    <form id="deleteForm-<?php echo e($topbar->id); ?>"
                                                        action="<?php echo e(route('topbar.delete', $topbar->id)); ?>"
                                                        method="POST" class="d-inline m-0">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <button type="button" class="delete-btn"
                                                            onclick="confirmDeleteTopBar('<?php echo e($topbar->id); ?>')">
                ...
                <div class="row" id="videoContent" style="display: none;">
                    <div class="col-12">
                        <div class="page-box">
                            <form action="<?php echo e(route('topbar.store')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text" class="form-control tagsinput" name="minimum_age_rules_points"
                                            data-role="tagsinput" required value="<?php echo e(old('minimum_age_rules_points')); ?>">
                                        <?php $__errorArgs = ['minimum_age_rules_points'];
...
<?php $__env->startSection('script'); ?>
    ...
    <?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\herd\barani_live\resources\views/topbar/index.blade.php ENDPATH**/ ?>
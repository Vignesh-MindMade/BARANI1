...
<?php $__env->startSection('wrapper'); ?>
    <div class="page-wrapper">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('testCurricular.index')); ?>">
                ...
                <div class="row mt-4" id="videoContentHomeFirst" style="display: none;">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('circulars.main.store')); ?>" method="POST"
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table id="example" class="table table-bordered""> 
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $circularsTest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $circular): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($loop->iteration); ?></td>
                                            <td>
                                                <strong><?php echo e($circular->title); ?></strong>
                                                <?php if($circular->span_title): ?>
                                                    <br><small class="text-muted"><?php echo e($circular->span_title); ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php
                                                ...
                                                ?>
                                                <?php if(in_array(strtolower($ext), ['jpeg','jpg','png','webp'])): ?>
                                                    <img src="<?php echo e(asset('images/' . $circular->catagory_image)); ?>"
                                                        alt="Category Image"
                                            ...
                                            <td class="action-buttons">
                                                <button class="smart-btn smart-btn-primary edit-btn-detail"
                                                    ...
                                                    data-bs-target="#editModal<?php echo e($circular->id); ?>">
                                                    <i class="fas fa-edit"></i> Edit
                                                </button>
                                                <button type="button"
                                                    class="smart-btn smart-btn-danger"
                                                    onclick="confirmDelete(<?php echo e($circular->id); ?>)">
                                                    <i class="fas fa-trash"></i> Delete
                                                </button>
                                                <form id="deleteForm<?php echo e($circular->id); ?>"
                                                    action="<?php echo e(route('circulars.main.destroy', $circular->id)); ?>"
                ...
                <div class=" page-box row mt-5">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="feature-card">
                            ...
                            <a href="<?php echo e(route('latestvideos.index')); ?>" class="btn psg-p-btn mt-2 w-100">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="feature-card">
                            ...
                            <a href="<?php echo e(route('results.index')); ?>" class="btn psg-p-btn mt-2 w-100">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="feature-card">
                            ...
                            <a href="<?php echo e(route('faq.index')); ?>" class="btn psg-p-btn mt-2 w-100">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="feature-card">
                            ...
                            <a href="<?php echo e(route('ourservice.index')); ?>" class="btn psg-p-btn mt-2 w-100">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="feature-card">
                            ...
                            <a href="<?php echo e(route('viewgallery.index')); ?>" class="btn psg-p-btn mt-2 w-100">
        ...
        <?php $__currentLoopData = $circularsTest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $circular): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- Edit Modal -->
            <div class="modal fade" id="editModal<?php echo e($circular->id); ?>" tabindex="-1"
                aria-labelledby="editModalLabel<?php echo e($circular->id); ?>" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"
                                id="editModalLabel<?php echo e($circular->id); ?>">
                        ...
                        <form
                            action="<?php echo e(route('circulars.main.update', $circular->id)); ?>"
                            ...
                            <div class="modal-body" style="padding: 20px;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                name="title"
                                                value="<?php echo e($circular->title); ?>"
                                                required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                name="span_title"
                                                value="<?php echo e($circular->span_title); ?>"
                                                required />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    ...
                                    <input type="file" class="form-control"
                                        name="catagory_image"
                                        accept="image/jpeg,image/png,image/jpg,image/webp,video/mp4,video/webm"
                                        id="catagory_image<?php echo e($circular->id); ?>"
                                        onchange="validateAndPreview(event, <?php echo e($circular->id); ?>)" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                           ...
                                           <div class="border rounded p-1 mt-2">
                                                <img id="imagePreview<?php echo e($circular->id); ?>"
                                                    src="<?php echo e(asset('images/' . $circular->catagory_image)); ?>"
                                                    alt="Preview"
                                                    class="img-fluid img-preview"
                                                    style="width:100%; height:120px; object-fit:cover; display: <?php echo e(in_array(strtolower(pathinfo($circular->catagory_image, PATHINFO_EXTENSION)), ['jpeg','jpg','png','webp']) ? 'block' : 'none'); ?>;" />
                                                <video id="videoPreview<?php echo e($circular->id); ?>"
                                                    src="<?php echo e(strtolower(pathinfo($circular->catagory_image, PATHINFO_EXTENSION)) === 'mp4' ? asset('images/' . $circular->catagory_image) : ''); ?>"
                                                    controls
                                                    style="width:100%; max-height:120px; display: <?php echo e(strtolower(pathinfo($circular->catagory_image, PATHINFO_EXTENSION)) === 'mp4' ? 'block' : 'none'); ?>;">
                                                </video>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="sort_id"
                                                value="<?php echo e($circular->sort_id); ?>"
                                                name="sort_id"
                                                placeholder="sort Id" />
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\herd\barani_live\resources\views/Backend/Home/index.blade.php ENDPATH**/ ?>
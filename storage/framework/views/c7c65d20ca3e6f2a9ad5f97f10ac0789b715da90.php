                            ...
                            <table id="example" class="table table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(route('testCurricular.index')); ?>" class="view-btn">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(route('facilties.index')); ?>" class="view-btn">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(route('groupsubmenu.index')); ?>" class="view-btn">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                        </td>
                                    </tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(route('jsr.index')); ?>" class="view-btn">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(route('supplier_space.index')); ?>" class="view-btn">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(route('sustainability.backend')); ?>" class="view-btn">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(route('capsubmenu.index')); ?>" class="view-btn">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(route('contactussss.index')); ?>" class="view-btn">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                        </td>
                                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\herd\barani_live\resources\views/Backend/dashboard_views/subpage.blade.php ENDPATH**/ ?>
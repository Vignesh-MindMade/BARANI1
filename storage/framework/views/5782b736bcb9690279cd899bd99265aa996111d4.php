    ...
    <div class="page-box page-content">
        <div class="banner-manager-container py-4 px-4">
            ...
            <div class="row align-items-center mb-4">
                <div class="col-md-6">
                    <h3 class="page-title mb-0"><i class="fas fa-edit text-primary me-2"></i> Edit Blog #<?php echo e($blog->id); ?></h3>
                </div>
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-md-end mb-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>" class="text-decoration-none"><i class="fas fa-home me-1"></i> Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo e(route('blogs-admin.index')); ?>" class="text-decoration-none">Blogs</a></li>
            ...
            <form action="<?php echo e(route('blogs-admin.update', $blog)); ?>" method="POST" enctype="multipart/form-data" id="blogForm">
                <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if($blog->banner_image): ?>
                                        <div class="file-info-box">
                                            ...
                                            Current: <a href="<?php echo e(asset('storage/' . $blog->banner_image)); ?>" target="_blank">View Image</a>
                                        </div>
                                    <?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?><span class="text-danger d-block" style="font-size: 12px;"><?php echo e($message); ?></span><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                    <div id="bannerPreviewContainer" class="mt-2" style="<?php echo e($blog->banner_image ? '' : 'display: none;'); ?>">
                                        <img id="bannerPreview" src="<?php echo e($blog->banner_image ? asset('storage/' . $blog->banner_image) : ''); ?>" class="img-preview" style="width: 100%; height: 120px;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Banner Title</label>
                                    <input type="text" name="banner_title" class="form-control" value="<?php echo e(old('banner_title', $blog->banner_title)); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="section1_subtitle" class="form-control" value="<?php echo e(old('section1_subtitle', $blog->section1_subtitle)); ?>">
                                </div>
                                <div class="col-md-8">
                                    <label class="form-label">Title <span class="text-danger">*</span></label>
                                    <input type="text" name="section1_title" class="form-control" value="<?php echo e(old('section1_title', $blog->section1_title)); ?>">
                                    <?php $__errorArgs = ['section1_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="text-danger" style="font-size: 12px;"><?php echo e($message); ?></span><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                </div>
                                <div class="col-12">
                                    ...
                                    <textarea name="section1_description" class="form-control" rows="2"><?php echo e(old('section1_description', $blog->section1_description)); ?></textarea>
                                </div>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?php $__errorArgs = ['card_thumbnail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="text-danger d-block" style="font-size: 12px;"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div id="cardPreviewContainer" class="mb-2">
                                        <img id="cardPreview" src="<?php echo e($blog->thumbnail_url); ?>" class="img-preview" style="width: 200px; height: 130px;">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Card Description</label>
                                    <textarea name="description" class="form-control" rows="3"><?php echo e(old('description', $blog->description)); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="alert alert-info d-flex align-items-center">
                                ...
                                <div>
                                    Content type is <strong class="text-uppercase"><?php echo e($blog->type); ?></strong>. Type cannot be changed after creation.
                                </div>
                                <input type="hidden" name="type" value="<?php echo e($blog->type); ?>">
                            </div>

                            
                            <?php if($blog->type === 'pdf'): ?>
                                <div class="type-section active">
                                    ...
                                    <?php if($blog->pdf_file): ?>
                                        <div class="file-info-box">
                                            ...
                                            Current: <a href="<?php echo e(route('blogs.pdf.view', $blog)); ?>" target="_blank"><?php echo e(basename($blog->pdf_file)); ?></a>
                                            <?php
                                                $pdfPath = storage_path('app/public/' . $blog->pdf_file);
                                                $pdfSize = file_exists($pdfPath) ? round(filesize($pdfPath) / 1024) : 0;
                                            ?>
                                            (<?php echo e($pdfSize); ?> KB)
                                        </div>
                                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if($blog->type === 'video'): ?>
                                <div class="type-section active">
                                    ...
                                    <div class="mb-3">
                                        <div class="btn-group">
                                            <button type="button" class="video-toggle-btn <?php echo e($blog->video_source == 'upload' ? 'active' : ''); ?>" onclick="selectVideoSource('upload')">
                                                <i class="fas fa-upload me-1"></i> Upload File
                                            </button>
                                            <button type="button" class="video-toggle-btn <?php echo e($blog->video_source == 'link' ? 'active' : ''); ?>" onclick="selectVideoSource('link')">
                                                <i class="fas fa-link me-1"></i> External Link
                                            </button>
                                        </div>
                                        <input type="hidden" name="video_source" id="videoSource" value="<?php echo e(old('video_source', $blog->video_source)); ?>">
                                    </div>

                                    <div id="videoUploadSection" class="<?php echo e($blog->video_source != 'link' ? '' : 'd-none'); ?>">
                                        ...
                                        <?php if($blog->video_file): ?>
                                            <div class="file-info-box">
                                                ...
                                                Current: <a href="<?php echo e(asset('storage/' . $blog->video_file)); ?>" target="_blank"><?php echo e(basename($blog->video_file)); ?></a>
                                            </div>
                                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div id="videoLinkSection" class="<?php echo e($blog->video_source == 'link' ? '' : 'd-none'); ?>">
                                        <label class="form-label">Video URL</label>
                                        <input type="url" name="video_url" class="form-control" value="<?php echo e(old('video_url', $blog->video_url)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-2">
                                        <label class="form-label">Current Gallery <span class="badge bg-info"><?php echo e($blog->images->count()); ?></span></label>
                                        <div id="galleryPreview" class="gallery-preview">
                                            <?php $__currentLoopData = $blog->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="gallery-preview-item existing" data-id="<?php echo e($image->id); ?>">
                                                    <img src="<?php echo e($image->image_url); ?>" alt="<?php echo e($image->caption); ?>">
                                                    <button type="button" class="remove-btn" onclick="toggleImageDelete(<?php echo e($image->id); ?>, this)" title="Remove">×</button>
                                                    <?php if($image->caption): ?>
                                                        <small style="position: absolute; bottom: 0; left: 0; right: 0; background: rgba(0,0,0,0.7); color: white; font-size: 10px; padding: 2px 4px; text-align: center;"><?php echo e(Str::limit($image->caption, 15)); ?></small>
                                                    <?php endif; ?>
                                                </div>
                        ...
                        <div class="form-section" style="position: sticky; top: 20px;">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="date" name="published_date" class="form-control" value="<?php echo e(old('published_date', $blog->published_date?->format('Y-m-d'))); ?>">
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Sort Order</label>
                                    <input type="number" name="sort_order" class="form-control" value="<?php echo e(old('sort_order', $blog->sort_order)); ?>" min="0">
                                </div>
                                <div class="col-12">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" name="is_active" class="form-check-input" id="isActive" value="1" <?php echo e(old('is_active', $blog->is_active) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-12 mt-4">
                                    ...
                                    <a href="<?php echo e(route('blogs-admin.index')); ?>" class="btn psg-s-btn w-100 mt-2">
                        ...
                        <div class="form-section" style="background: white;">
                            ...
                            <div class="preview-card">
                                <div class="preview-img">
                                    ...
                                    <span class="preview-badge" style="background: <?php echo e($blog->type_badge_color); ?>;">
                                        <?php echo e($blog->type_label); ?>

                                    </span>
                                </div>
                                <div class="preview-body">
                                    <div style="font-size: 11px; color: #888; margin-bottom: 4px;">
                                        <?php echo e($blog->published_date?->format('d F Y') ?? 'No Date'); ?>
                                    ...
                                    <p style="font-size: 11px; color: #666; line-height: 1.4; margin: 0;">
                                        <?php echo e(Str::limit($blog->description, 80)); ?>

                                    </p>
                                </div>
                            </div>
                            <div class="text-center mt-3">
                                <a href="<?php echo e(route('blogs-admin.index')); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\herd\barani_live\resources\views/Backend/blogs/edit.blade.php ENDPATH**/ ?>
...
<div class="page-wrapper">
    <div class="page-box page-content">
        <div class="banner-manager-container py-4 px-4">
                ...
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-md-end mb-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('testCurricular.index')); ?>" class="text-decoration-none"><i class="fas fa-home me-1"></i> Dashboard</a></li>
                   ...
                   <div class="col-md-6 text-end d-flex">
                    <a href="<?php echo e(route('blogs.create')); ?>" class="btn btn-primary me-2">
                        <i class="fas fa-plus me-2"></i> Create New Blog Post
                    </a>
                    <a href="<?php echo e(route('blogs.index')); ?>" class="btn btn-outline-primary">
            ...
            <!-- Settings Form -->
            <form action="<?php echo e(route('blog.settings.update')); ?>" method="POST" enctype="multipart/form-data" id="blogSettingsForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <?php if($settings && $settings->banner_image): ?>
                            <div class="mb-3 banner-preview-container">
                                <img src="<?php echo e(asset('storage/' . $settings->banner_image)); ?>" alt="Current Banner" class="img-preview" id="currentBannerPreview">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" 
                                       name="banner_title" 
                                       id="banner_title" 
                                       class="form-control <?php $__errorArgs = ['banner_title'];
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('banner_title', $settings->banner_title ?? '')); ?>" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="section_subtitle" 
                                       class="form-control <?php $__errorArgs = ['section_subtitle'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('section_subtitle', $settings->section_subtitle ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('section_title', $settings->section_title ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="5" 
                                      placeholder="Enter section description..."><?php echo e(old('section_description', $settings->section_description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-between align-items-center pt-3">
                    <a href="<?php echo e(route('testCurricular.index')); ?>" class="btn btn-outline-secondary">
            ...
            <!-- Hidden Delete Form -->
            <form id="deleteBannerForm" action="<?php echo e(route('blog.settings.banner.destroy')); ?>" method="POST" class="d-none">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\herd\barani_live\resources\views/Backend/blog/settings.blade.php ENDPATH**/ ?>
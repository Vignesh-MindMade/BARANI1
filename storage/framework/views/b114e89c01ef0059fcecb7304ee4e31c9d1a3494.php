...
<?php $__env->startSection('wrapper'); ?>
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-box animate-fade-in">
                ...
                <?php $__currentLoopData = $heading; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <form method="POST" action="<?php echo e(route('aboutus.update', $head->id)); ?>" enctype="multipart/form-data"
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($head->banner_image): ?>
                                <img src="<?php echo e(asset('images/' . $head->banner_image)); ?>" width="120"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="aboutus_description" rows="3"><?php echo e($head->aboutus_description); ?></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($head->aboutus_image_1): ?>
                                <img src="<?php echo e(asset('images/' . $head->aboutus_image_1)); ?>" width="120"
                                    class="mt-2 rounded shadow-sm">
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($head->aboutus_image_2): ?>
                                <img src="<?php echo e(asset('images/' . $head->aboutus_image_2)); ?>" width="120"
                                    class="mt-2 rounded shadow-sm">
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="mission_description" rows="3"><?php echo e($head->mission_description); ?></textarea>
                        </div>

                        <!-- Vision Description -->
                        <div class="mb-3">
                            <label class="form-label fw-medium">Vision Description</label>
                            <textarea class="form-control" name="vission_description" rows="3"><?php echo e($head->vission_description); ?></textarea>
                        </div>
                            <!-- history Description -->
                        <div class="mb-3">
                            <label class="form-label fw-medium">History Description</label>
                            <textarea class="form-control" name="history_description" rows="3"><?php echo e($head->history_description); ?></textarea>
                        </div>
                        <!-- Submit -->
                        ...
                        <div class="page-box animate-fade-in">
                            ...
                            <div id="videoContent" style="display: none;" class="animate-fade-in">
                                <div class="form-section mt-3 mb-4">
                                    ...
                                    <form action="<?php echo e(route('facilties.store')); ?>" method="POST"
                            ...
                            <div class="table-responsive">
                                <table id="Latestvidesoass" class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $Facilties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($key + 1); ?></td>
                                                <td>
                                                    <strong><?php echo e($video->title); ?></strong>
                                                    <div class="text-muted small mt-1">Order:
                                                        #<?php echo e($video->sort_id ?? 'N/A'); ?></div>
                                                    <div class="text-truncate small mt-1" style="max-width: 350px;">
                                                        <?php echo e($video->description); ?></div>
                                                </td>
                                                <td class="text-center">
                                                    <?php if($video->image2): ?>
                                                        <div class="img-thumbnail-container">
                                                            <img src="<?php echo e(asset('images/' . $video->image2)); ?>"
                                                ...
                                                <td>
                                                    <div class="action-btns">
                                                        <button type="button"
                                                            ...
                                                            data-link2="<?php echo e($video->link2); ?>"
                                                            data-sort_id="<?php echo e($video->sort_id); ?>"
                                                            data-image2="<?php echo e($video->image2); ?>"
                                                            data-description="<?php echo e($video->description); ?>"
                                                            data-action="<?php echo e(route('facilties.update', $video->id)); ?>"
                ...
                <div class="d-flex justify-content-start gap-3 mt-4">
                    <a href="<?php echo e(route('view_awards.index')); ?>" class="btn btn-primary btn-lg px-4 py-2 text-white text-decoration-none shadow-sm hover-shadow-lg transition-all">
                        <i class="fas fa-trophy me-2"></i>View Awards
                    </a>
                    <a href="<?php echo e(route('curriculam.index')); ?>" class="btn btn-primary btn-lg px-4 py-2 text-white text-decoration-none shadow-sm hover-shadow-lg transition-all">
                        <i class="fas fa-shield-alt me-2"></i>Quality Assurance
                    </a>
                    <a href="<?php echo e(route('team.testindex')); ?>" class="btn btn-primary btn-lg px-4 py-2 text-white text-decoration-none shadow-sm hover-shadow-lg transition-all">
                        <i class="fas fa-users me-2"></i>Team
                    </a>
                     <a href="<?php echo e(route('view_certficate_title.index')); ?>" class="btn btn-primary btn-lg px-4 py-2 text-white text-decoration-none shadow-sm hover-shadow-lg transition-all">
        ...
        <?php $__currentLoopData = $Facilties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <form id="delete-form-<?php echo e($video->id); ?>" action="<?php echo e(route('facilties.destroy', $video->id)); ?>"
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                editButtons.forEach((button) => {
                    button.addEventListener("click", function() {
                        ...
                        if (image2) {
                            const imagePath = "<?php echo e(asset('images')); ?>/" + image2;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\herd\barani_live\resources\views/Backend/Home/facilties.blade.php ENDPATH**/ ?>
...
!(function (t, e) {
    ...
    function Ma(t, e, r, i, n) {
        return (
            Kt(t, e, n),
            t._initted
                ? !r && t._pt && !B && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && f !== Rt.frame
                ...
                (u = new pt[t]()).init(
                    ...
                    u.rawVars
                        ...
                        : (function _processVars(t, e, i, n, a) {
                              if ((s(t) && (t = Gt(t, a, e, i, n)), !v(t) || (t.style && t.nodeType) || Z(t) || J(t)))
        ...
        Qt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
            ...
            if (
                ...
                return isNaN(p * n) || "" === n
                    ...
                    : ((c = new ge(this._pt, t, e, +p || 0, n - (p || 0), "boolean" == typeof d ? oe : se, 0, _)),
                      l && (c.fp = l),
            ...
            if (
                ...
                for (t._pt = t._ptCache = 0, T = (C && w(T)) || (T && !C), n = 0; n < D.length; n++) {
                    ...
                    t._op && t._op[n] && t.kill(o, t._op[n]),
                        R && t._pt && ((Nt = t), L.killTweensOf(o, c, t.globalTime(e)), (_ = !t.parent), (Nt = 0)),
                        t._pt && T && (dt[h.id] = 1);
                }
                    ...
                    if (Z(x))
                        ...
                        for (l in u)
                            for (
                                ...
                                ((D = { ease: (P = C[o]).e, duration: ((P.t - (o ? C[o - 1].t : 0)) / 100) * _ })[l] =
                                    P.v),
                                    s.to(S, D, E),
                                    (E += D.duration);
    ...
    function Kd() {
        ...
        for (t = 0; t < r.length; t += 3)
            r[t + 1]
                ...
                : r[t + 2]
                  ? (n[r[t]] = r[t + 2])
                  : n.removeProperty("--" === r[t].substr(0, 2) ? r[t] : r[t].replace(ur, "-$1").toLowerCase());
        if (this.tfm) {
    ...
    var De,
        ...
        vr = function _get(t, e, r, i) {
            ...
            return (
                ...
                nr[e] && "transform" !== e
                    ? ((n = xr(t, i)),
                      (n = "transformOrigin" !== e ? n[e] : n.svg ? n.origin : Or(Od(t, dr)) + " " + n.zOrigin + "px"))

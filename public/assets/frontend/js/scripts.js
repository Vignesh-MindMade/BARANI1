$(function () {
  ...
  var parallaxSliderOptions = {
    ...
    on: {
      init: function () {
        ...
        var duration = swiper.params.autoplay.delay + swiper.params.speed;
  ...
  // Start animation for first slide on load
  var duration =
    parallaxSlider.params.autoplay.delay + parallaxSlider.params.speed;
  $(".swiper-pagination-bullet-active .progress").animate(
    { width: "100%" },
    duration
  );
